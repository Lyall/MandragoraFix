...
{
public:
	bool                                          ResetActiveChild;                                  // 0x0010(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ResetBlendTime;                                    // 0x0011(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_12[0x6];                                       // 0x0012(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FPoseLink>                      BlendPose;                                         // 0x0018(0x0010)(Edit, BlueprintVisible, EditFixedSize, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 BlendTime;                                         // 0x0028(0x0010)(Edit, BlueprintVisible, EditFixedSize, ZeroConstructor, NativeAccessSpecifierPublic)
	EBlendListTransitionType                      TransitionType;                                    // 0x0038(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAlphaBlendOption                             BlendType;                                         // 0x0039(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bResetChildOnActivation;                           // 0x003A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(FAnimNode_BlendListBase, ResetActiveChild) == 0x000010, "Member 'FAnimNode_BlendListBase::ResetActiveChild' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendListBase, ResetBlendTime) == 0x000011, "Member 'FAnimNode_BlendListBase::ResetBlendTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendListBase, BlendPose) == 0x000018, "Member 'FAnimNode_BlendListBase::BlendPose' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendListBase, BlendTime) == 0x000028, "Member 'FAnimNode_BlendListBase::BlendTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendListBase, TransitionType) == 0x000038, "Member 'FAnimNode_BlendListBase::TransitionType' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendListBase, BlendType) == 0x000039, "Member 'FAnimNode_BlendListBase::BlendType' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendListBase, bResetChildOnActivation) == 0x00003A, "Member 'FAnimNode_BlendListBase::bResetChildOnActivation' has a wrong offset!");
