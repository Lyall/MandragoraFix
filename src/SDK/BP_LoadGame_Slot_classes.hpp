...
// WidgetBlueprintGeneratedClass BP_LoadGame_Slot.BP_LoadGame_Slot_C
// 0x00E0 (0x0368 - 0x0288)
class UBP_LoadGame_Slot_C final : public ULoadGameSlotUserWidget
{
public:
...
public:
	...
	void BndEvt__BP_LoadGame_Slot_ButtonFrame_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature();
	void ExecuteUbergraph_BP_LoadGame_Slot(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"BP_LoadGame_Slot_C">();
	}
	static class UBP_LoadGame_Slot_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBP_LoadGame_Slot_C>();
	}
};
static_assert(alignof(UBP_LoadGame_Slot_C) == 0x000008, "Wrong alignment on UBP_LoadGame_Slot_C");
static_assert(sizeof(UBP_LoadGame_Slot_C) == 0x000368, "Wrong size on UBP_LoadGame_Slot_C");
static_assert(offsetof(UBP_LoadGame_Slot_C, UberGraphFrame) == 0x000288, "Member 'UBP_LoadGame_Slot_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, HighlightAnim) == 0x000290, "Member 'UBP_LoadGame_Slot_C::HighlightAnim' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, Bg) == 0x000298, "Member 'UBP_LoadGame_Slot_C::Bg' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, Bg_Highlight) == 0x0002A0, "Member 'UBP_LoadGame_Slot_C::Bg_Highlight' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, ButtonFrame) == 0x0002A8, "Member 'UBP_LoadGame_Slot_C::ButtonFrame' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, Data) == 0x0002B0, "Member 'UBP_LoadGame_Slot_C::Data' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, EmptySlotCaption) == 0x0002B8, "Member 'UBP_LoadGame_Slot_C::EmptySlotCaption' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, LastPlayed) == 0x0002C0, "Member 'UBP_LoadGame_Slot_C::LastPlayed' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, LastPlayedLabel) == 0x0002C8, "Member 'UBP_LoadGame_Slot_C::LastPlayedLabel' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, LevelAndClass) == 0x0002D0, "Member 'UBP_LoadGame_Slot_C::LevelAndClass' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, Location) == 0x0002D8, "Member 'UBP_LoadGame_Slot_C::Location' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, LocationLabel) == 0x0002E0, "Member 'UBP_LoadGame_Slot_C::LocationLabel' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, Name_0) == 0x0002E8, "Member 'UBP_LoadGame_Slot_C::Name_0' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, TimeSpent) == 0x0002F0, "Member 'UBP_LoadGame_Slot_C::TimeSpent' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, TimeSpentLabel) == 0x0002F8, "Member 'UBP_LoadGame_Slot_C::TimeSpentLabel' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, VersionMismatchLabel) == 0x000300, "Member 'UBP_LoadGame_Slot_C::VersionMismatchLabel' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, Warning) == 0x000308, "Member 'UBP_LoadGame_Slot_C::Warning' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, OnHovered) == 0x000310, "Member 'UBP_LoadGame_Slot_C::OnHovered' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, OnUnhovered) == 0x000320, "Member 'UBP_LoadGame_Slot_C::OnUnhovered' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, OnReleased) == 0x000330, "Member 'UBP_LoadGame_Slot_C::OnReleased' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, OnPressed) == 0x000340, "Member 'UBP_LoadGame_Slot_C::OnPressed' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, OnUnfocus) == 0x000350, "Member 'UBP_LoadGame_Slot_C::OnUnfocus' has a wrong offset!");
static_assert(offsetof(UBP_LoadGame_Slot_C, IsSmallScreen) == 0x000360, "Member 'UBP_LoadGame_Slot_C::IsSmallScreen' has a wrong offset!");
