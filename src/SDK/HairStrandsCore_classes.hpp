...
{
public:
	class UGroomComponent*                        GroomComponent;                                    // 0x0228(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AGroomActor) == 0x000230, "Wrong size on AGroomActor");
static_assert(offsetof(AGroomActor, GroomComponent) == 0x000228, "Member 'AGroomActor::GroomComponent' has a wrong offset!");
