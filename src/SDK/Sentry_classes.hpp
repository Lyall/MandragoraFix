...
static_assert(sizeof(USentrySamplingContext) == 0x000038, "Wrong size on USentrySamplingContext");
...
public:
	...
	TSubclassOf<class USentryBeforeSendHandler>   BeforeSendHandler;                                 // 0x00A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          EnableAppNotRespondingTracking;                    // 0x00C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableTracing;                                     // 0x00C9(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESentryTracesSamplingType                     SamplingType;                                      // 0x00CA(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TSubclassOf<class USentryTraceSampler>        TracesSampler;                                     // 0x00D0(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USentrySettings) == 0x000140, "Wrong size on USentrySettings");
...
static_assert(offsetof(USentrySettings, AutomaticBreadcrumbsForLogs) == 0x000069, "Member 'USentrySettings::AutomaticBreadcrumbsForLogs' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableAutoSessionTracking) == 0x00006E, "Member 'USentrySettings::EnableAutoSessionTracking' has a wrong offset!");
static_assert(offsetof(USentrySettings, SessionTimeout) == 0x000070, "Member 'USentrySettings::SessionTimeout' has a wrong offset!");
static_assert(offsetof(USentrySettings, OverrideReleaseName) == 0x000074, "Member 'USentrySettings::OverrideReleaseName' has a wrong offset!");
...
static_assert(offsetof(USentrySettings, EnableAppNotRespondingTracking) == 0x0000C8, "Member 'USentrySettings::EnableAppNotRespondingTracking' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableTracing) == 0x0000C9, "Member 'USentrySettings::EnableTracing' has a wrong offset!");
static_assert(offsetof(USentrySettings, SamplingType) == 0x0000CA, "Member 'USentrySettings::SamplingType' has a wrong offset!");
static_assert(offsetof(USentrySettings, TracesSampleRate) == 0x0000CC, "Member 'USentrySettings::TracesSampleRate' has a wrong offset!");
static_assert(offsetof(USentrySettings, TracesSampler) == 0x0000D0, "Member 'USentrySettings::TracesSampler' has a wrong offset!");
static_assert(offsetof(USentrySettings, TagsPromotion) == 0x0000D8, "Member 'USentrySettings::TagsPromotion' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableBuildConfigurations) == 0x0000DE, "Member 'USentrySettings::EnableBuildConfigurations' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableBuildTargets) == 0x0000E3, "Member 'USentrySettings::EnableBuildTargets' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableBuildPlatforms) == 0x0000E8, "Member 'USentrySettings::EnableBuildPlatforms' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableForPromotedBuildsOnly) == 0x0000ED, "Member 'USentrySettings::EnableForPromotedBuildsOnly' has a wrong offset!");
static_assert(offsetof(USentrySettings, UploadSymbolsAutomatically) == 0x0000EE, "Member 'USentrySettings::UploadSymbolsAutomatically' has a wrong offset!");
static_assert(offsetof(USentrySettings, ProjectName) == 0x0000F0, "Member 'USentrySettings::ProjectName' has a wrong offset!");
static_assert(offsetof(USentrySettings, OrgName) == 0x000100, "Member 'USentrySettings::OrgName' has a wrong offset!");
static_assert(offsetof(USentrySettings, AuthToken) == 0x000110, "Member 'USentrySettings::AuthToken' has a wrong offset!");
static_assert(offsetof(USentrySettings, IncludeSources) == 0x000120, "Member 'USentrySettings::IncludeSources' has a wrong offset!");
static_assert(offsetof(USentrySettings, DiagnosticLevel) == 0x000121, "Member 'USentrySettings::DiagnosticLevel' has a wrong offset!");
static_assert(offsetof(USentrySettings, CrashReporterUrl) == 0x000128, "Member 'USentrySettings::CrashReporterUrl' has a wrong offset!");
...
static_assert(sizeof(USentrySpan) == 0x000038, "Wrong size on USentrySpan");
...
public:
	...
	class USentryTraceSampler*                    TraceSampler;                                      // 0x0068(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USentrySubsystem) == 0x0000A8, "Wrong size on USentrySubsystem");
...
static_assert(offsetof(USentrySubsystem, TraceSampler) == 0x000068, "Member 'USentrySubsystem::TraceSampler' has a wrong offset!");
...
static_assert(sizeof(USentryTransactionContext) == 0x000038, "Wrong size on USentryTransactionContext");
