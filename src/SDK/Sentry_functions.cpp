...
// Parameters:
// class USentryEvent*                     Event                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TDelegate<void(class USentryScope* Scope)>OnConfigureScope                                       (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// class USentryId*                        ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Final, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// TDelegate<void(class USentrySettings* Settings)>OnConfigureSettings                                    (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
class USentrySpan* USentryTransaction::StartChild(const class FString& Operation, const class FString& Description)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("SentryTransaction", "StartChild");

	Params::SentryTransaction_StartChild Parms{};
